...
import { X, ExternalLink, Github, Cpu, BarChart2, Layers } from 'lucide-react';
    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 bg-black/85 backdrop-blur-md">
        <motion.div
          ...
          className="relative w-full max-w-4xl glass-panel border border-red-600/60 p-6 sm:p-10 bg-[#070709] text-white shadow-[0_0_60px_rgba(220,38,38,0.3)] max-h-[90vh] overflow-y-auto"
        >
          {/* Header */}
          <div className="flex justify-between items-start pb-6 border-b border-white/10">
            <div>
              <div className="flex items-center gap-3 text-xs font-mono text-red-500 tracking-widest uppercase mb-1">
          ...
          <div className="mt-6 space-y-8">
            {/* Banner Image */}
            <div className="relative h-64 sm:h-80 w-full overflow-hidden border border-white/10">
              <img
                src={project.image}
                alt={project.title}
          ...
          <div className="mt-8 pt-6 border-t border-white/10 flex flex-wrap justify-between items-center gap-4">
            <a
              ...
              className="inline-flex items-center gap-2 px-6 py-3 bg-zinc-900 hover:bg-white text-white hover:text-black font-black uppercase text-xs tracking-widest border border-white/20 transition-all"
            >
              <Github size={16} />
            ...
            <button
              ...
              className="px-8 py-3 bg-red-600 hover:bg-white text-white hover:text-black font-black uppercase text-xs tracking-widest transition-all"
            >
              CLOSE CASE STUDY
            </button>
          </div>
