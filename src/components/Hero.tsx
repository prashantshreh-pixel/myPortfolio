  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto flex flex-col justify-center h-full">
        ...
        {/* Swinging ICHIGOZ GIF */}
        <div className="absolute right-[10%] bottom-[20%] hidden md:block z-20 pointer-events-none">
          <motion.img
            src="/assets/gif/ICHIGOZ.gif"
            alt="Ichigo Swinging"
            animate={{ 
              rotate: [-4, 4, -4],
              y: [-10, 10, -10]
            ...
            className="w-64 lg:w-80 object-contain drop-shadow-[0_0_20px_rgba(220,38,38,0.4)] opacity-70 mix-blend-screen origin-top"
          />
        </div>
        ...
        <div className="max-w-3xl ml-0 lg:ml-20 relative z-20">
          ...
          <motion.div
            ...
            transition={{ duration: 0.8, delay: 0.1 }}L
